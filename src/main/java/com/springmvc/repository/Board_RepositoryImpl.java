...
public class Board_RepositoryImpl implements Board_Repository {
	...
	public void create(board bd) {
		...
		jdbcTemplate.update(sql, bd.getId(), bd.getName(), bd.getSubject(), bd.getContent(), bd.getRegistDay(),
				bd.getHit(), bd.getIp(), bd.getTarget(), bd.getInstitute());
	}
	...
	public void update(board bd) {
		...
		jdbcTemplate.update(sql, bd.getSubject(), bd.getContent(), bd.getRegistDay(), bd.getIp(), bd.getTarget(),
				bd.getInstitute(), bd.getNum());
	}
