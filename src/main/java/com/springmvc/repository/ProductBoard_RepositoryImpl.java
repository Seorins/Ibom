...
public class ProductBoard_RepositoryImpl implements ProductBoard_Repository {
	...
	public void addProductBoard(productboard productBoard) {
		...
		jdbcTemplate.update(sql, productBoard.getId(), productBoard.getProduct_id(), productBoard.getRegistDay(),
				productBoard.getHit(), productBoard.getIp());
	}
	...
	public void update(productboard productBoard) {
		...
		jdbcTemplate.update(sql, productBoard.getRegistDay(), productBoard.getHit(), productBoard.getIp(),
				productBoard.getId());
	}
