...
public class Injection_RepositoryImpl implements Injection_Repository {
	...
	public void insertBirth(String id, LocalDate birthdayDate, Map<String, LocalDate> injectionDates) {
		...
		try {
			jdbcTemplate.update(sql, id, birthdayDate, injectionDates.get("BCG"), injectionDates.get("HepB_1"),
					injectionDates.get("HepB_2"), injectionDates.get("DTaP_1"), injectionDates.get("IPV_1"),
					injectionDates.get("Hib_1"), injectionDates.get("PCV_1"), injectionDates.get("RV_1"),
					injectionDates.get("RV2_1"), injectionDates.get("DTaP_2"), injectionDates.get("IPV_2"),
					injectionDates.get("Hib_2"), injectionDates.get("PCV_2"), injectionDates.get("RV_2"),
					injectionDates.get("RV2_2"), injectionDates.get("HepB_3"), injectionDates.get("DTaP_3"),
					injectionDates.get("IPV_3"), injectionDates.get("Hib_3"), injectionDates.get("PCV_3"),
					injectionDates.get("RV2_3"), injectionDates.get("Hib_4"), injectionDates.get("PCV_4"),
					injectionDates.get("MMR_1"), injectionDates.get("VAR_1"), injectionDates.get("HepA_1"),
					injectionDates.get("IJEV_1"), injectionDates.get("LJEV_1"), injectionDates.get("IJEV_2"),
					injectionDates.get("DTaP_4"), injectionDates.get("PPSV"), injectionDates.get("HepA_2"),
					injectionDates.get("IJEV_3"), injectionDates.get("LJEV_2"));
		} catch (Exception e) {
