...
public class childcontroller {
	...
	public String childAlllist(Model model, HttpServletRequest request) {
		...
		List<child> childList = childservice.readAll(sessionId);
	...
	// readone
	/*
	 * @GetMapping("/details") public String childone(@RequestParam("one")String
	 * childname, Model model) { System.out.println("디테일"); child childone =
	 * childservice.readone(childname); model.addAttribute("readone",childone);
	 * return "childone"; }
	 */
	 ...
	 * updateChild(@ModelAttribute("childmodel") child baby) {
	 * System.out.println("update controller"); childservice.update(baby); return
	 * "redirect:/childs/childlist"; }
	 * 
	 */
