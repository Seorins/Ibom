...
public class HospitalController {
	...
	public String hospitalform(@RequestParam String name, Model model, HttpServletRequest request) {
		...
		List<String> availableTimes = Arrays.asList("09:00", "10:00", "11:00", "12:00", "13:00", "14:00", "15:00",
				"16:00");
	...
	public String reserveRead(@RequestParam String id, @RequestParam String date, @RequestParam String time,
			Model model) {
	...
	public String reserveDelete(@RequestParam String id, @RequestParam String date, @RequestParam String time,
			Model model) {
	...
	public String reserveDelete2(@RequestParam String id, @RequestParam String date, @RequestParam String time,
			Model model) {
		service.deleteReservation(id, date, time);
