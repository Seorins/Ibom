...
public class momcontroller {
	...
	// readall
	@GetMapping("/momlist")
	public String momlist(@RequestParam(value = "page", defaultValue = "1") int page, Model model,
		...
		List<mom> momlist = momService.readall(sessionId); // 전체 목록을 가져옵니다.
	...
	public List<mom> getMomData(HttpServletRequest request) {
		...
		return momService.readall(sessionId); // 모든 산모 데이터를 반환
	}
