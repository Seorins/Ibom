...
public class InjectionListController {
	...
	@ResponseBody
	public List<InjectionList> getInjectionList(@RequestParam String userid,
	...
	@ResponseBody
	public boolean checkInjectionList(@RequestParam("userid") String userid, @RequestParam("title") String title,
		...
		try {
			...
			System.out.println(
					"Received request with userid: " + userid + ", title: " + decodedTitle + ", birth: " + birth);
