...
<script>
    ...
    function loadPage(pageNum) {
        ...
        $.ajax({
            ...
            type: "post",
            data: JSON.stringify({ category: items, text: search, pageNum: pageNum }), // pageNum 추가
            contentType: "application/json",
            success: function(data) {
                console.log("서버 응답:", data);

                // 'data' 객체에서 'list'와 'totalPages'를 추출
                var boardList = data.list; // 해당 페이지의 게시물 리스트
                ...
                // 페이징 처리 (totalPages를 이용해 페이지 링크 생성)
