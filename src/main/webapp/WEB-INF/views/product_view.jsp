                ...
                <div class="col-md-6">
                    <div class="product-info">
                        <div class="image-container mb-3">
                            <img src="${pageContext.request.contextPath}/resources/images/<%= product.getImage() %>" alt="<%= product.getName() %>" class="img-fluid rounded">
                        </div>
                        <div class="text">
...
<script>
	...
	function deleteReview(num) {
	    if (confirm("리뷰를 삭제하시겠습니까?")) { 
	        $.ajax({
	            type: "POST",
	            url: "/ibom/product/reviewdelete",
	            data: JSON.stringify({ num: num, parents_num:parents_num }),
	            contentType: "application/json",
	            success: function(response) {
	            	updateReviewTable(response); 
	                alert("리뷰가 삭제되었습니다.");
