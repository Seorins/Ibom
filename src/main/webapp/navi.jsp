...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/navi.css">
    <style>
        .logout-btn {
                    ...
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item dropdown">
				          ...
				          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
				            <li><a class="dropdown-item" href="/ibom/mom/momlist">산부인과 방문 수첩</a></li>
				            <li><a class="dropdown-item" href="/ibom/apimap">전국 산부인과 찾기</a></li>
				          </ul>
				        </li> 
				        ...
				        <li class="nav-item dropdown">
				          ...
				          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
				            <li><a class="dropdown-item" href="/ibom/calendar">예방접종 수첩</a></li>
				            <li><a class="dropdown-item" href="/ibom/childs/childlist">아기 정보</a></li>
				            <li><a class="dropdown-item" href="/ibom/processCsv">아기 제품</a></li>
				          </ul>
				        </li>     
				        ...
				        <li class="nav-item dropdown">
				          ...
				          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
				            <li><a class="dropdown-item" href="/ibom/board/list?pageNum=1">복지제도</a></li>
				          </ul>
				        </li>      
				         ...
				         <li class="nav-item dropdown">
						    <c:if test="${sessionScope.member.id == 'admin'}">
						        ...
						        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
						            <li><a class="dropdown-item" href="/ibom/manage">회원 관리</a></li>
						        </ul>
						    </c:if>
						</li>
